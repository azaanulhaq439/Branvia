...
const Add = ({token}) => {
    ...
    const [category, setCategory] = useState('Men'); // ✅ fixed case (setcategory → setCategory)
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full">
            ...
            <div>
                ...
                >
                    ...
                    <option value="Stollers & Shawls">Stollers & Shawls</option>
            ...
            <div>
                ...
                <input
                    ...
                    className="w-full px-3 py-2 sm:w-[120px] border rounded-md"
                    type="number"
                    placeholder="250"
                    required
                />
